...
SET @storeid='CN010003';
            select
                    ...
                    ROUND((if(end_time1=0 or start_time1=0,0, end_time1- start_time1)+
                       if(end_time2=0 or start_time2=0,0, end_time2- start_time2)+
                       if(end_time3=0 or start_time3=0,0, end_time3- start_time3)+
                       if(end_time4=0 or start_time4=0,0, end_time4- start_time4)+
                       if(end_time5=0 or start_time5=0,0, end_time5- start_time5) +
                       if(end_time6=0 or start_time6=0,0, end_time6- start_time6))/3600,2) as count_time,
